// Généré depuis silk-cascade (2).html — ne pas éditer à la main (regénérer avec node scripts/extract-silk-shader.mjs)
export const SILK_VERT = "attribute vec2 a_pos; void main(){gl_Position=vec4(a_pos,0,1);}";
